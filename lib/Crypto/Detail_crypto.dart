                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color:
                        _index == 0 ? const Color(0xff6B39F4) :notifier.tabBar4 ,
                      ),
                      child: Center(
                          child: Text("24H",
                              style: TextStyle(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10),
                        color: _index == 1 ?const Color(0xff6B39F4)  :notifier.tabBar4,/*? Color(0xff6B39F4) : Color(0xffF8F9FD),*/
                      ),
                      child: Center(
                          child: Text("1W",
                              style: TextStyle(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10),
                        color:
                        _index == 2 ?const Color(0xff6B39F4)  :notifier.tabBar4,
                      ),
                      child: Center(
                          child: Text("1M",
                              style: TextStyle(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10),
                        color:
                        _index == 3 ?const Color(0xff6B39F4)  :notifier.tabBar4,
                      ),
                      child: Center(
                          child: Text("1Y",
                              style: TextStyle(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10),
                        color:
                        _index == 4 ?const Color(0xff6B39F4)  :notifier.tabBar4,
                      ),
                      child: Center(
                          child: Text("ALL",
                              style: TextStyle(
