...
class History_stock extends StatefulWidget {
  const History_stock({super.key});

  @override
  State<History_stock> createState() => _History_stockState();
}

class _History_stockState extends State<History_stock> {
