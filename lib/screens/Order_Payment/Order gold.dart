...
class Order_gold extends StatefulWidget {
  const Order_gold({super.key});

  @override
  State<Order_gold> createState() => _Order_goldState();
}

class _Order_goldState extends State<Order_gold> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Order Gold",
            style: TextStyle(
                color: Colors.white, fontSize: 14, fontFamily: "Manrope-Bold")),
      ),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              const Image(
                                  image:
                                      AssetImage("assets/images/gold_icon.png"),
                                  height: 40,
                                  width: 40),
                              const SizedBox(
                                width: 15,
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text("Total buy",
                                  style: TextStyle(
                                      color: notifier.bottom, fontSize: 14)),
                              const Spacer(),
                              Text(
                                " 140.00",
                                style: TextStyle(
