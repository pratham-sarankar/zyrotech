...
class Order_nft extends StatefulWidget {
  const Order_nft({super.key});

  @override
  State<Order_nft> createState() => _Order_nftState();
}

class _Order_nftState extends State<Order_nft> {
                            ...
                            children: [
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image:
                                        AssetImage("assets/images/Genesis.png"),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
