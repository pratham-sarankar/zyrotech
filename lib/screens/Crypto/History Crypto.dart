...
class History_crypto extends StatefulWidget {
  const History_crypto({super.key});

  @override
  State<History_crypto> createState() => _History_cryptoState();
}

class _History_cryptoState extends State<History_crypto> {
