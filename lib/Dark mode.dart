...
class ColorNotifire with ChangeNotifier {
  ...
  get outlinedButtonColor=> isDark?const Color(0xff6B39F4):const Color(0xff6B39F4);
  get background => isDark ? const Color(0xff0F172A) : Colors.white;
  get onboardBackgroundColor => isDark ? const Color(0xff1E293B) : const Color(0xffF8F9FD);
  get textColor => isDark ? Colors.white : const Color(0xff0F172A);
  get getContainerBorder => isDark?const Color(0xff334155):const Color(0xffE2E8F0);
  ...
  get textFieldHintText => isDark ? const Color(0xff164748b) : const Color(0xff94A3B8);
  get passwordIcon => isDark ? const Color(0xff64748B) : const Color(0xff94A3B8);
  ...
  get linerIndicator => isDark?const Color(0xff334155):const Color(0xffF1F5F9);
