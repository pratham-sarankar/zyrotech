              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    height: height/19,
                    width: width/6,
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: index6==0?const Color(0xff6B39F4):Colors.blue.withOpacity(0.1),),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    height: height/19,
                    width: width/6,
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: index6==1?const Color(0xff6B39F4):Colors.blue.withOpacity(0.1),),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    height: height/19,
                    width: width/6,
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: index6==2?const Color(0xff6B39F4):Colors.blue.withOpacity(0.1),),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    height: height/19,
                    width: width/6,
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: index6==3?const Color(0xff6B39F4):Colors.blue.withOpacity(0.1),),
