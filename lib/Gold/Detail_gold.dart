          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      height: height/20,
                      width: width/7,
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: index6==0?const Color(0xff6B39F4)  :notifier.tabBar4,),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      height: height/20,
                      width: width/7,
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: index6==1?const Color(0xff6B39F4)  :notifier.tabBar4,),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      height: height/20,
                      width: width/7,
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: index6==2?const Color(0xff6B39F4)  :notifier.tabBar4,),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      height: height/20,
                      width: width/7,
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: index6==3?const Color(0xff6B39F4)  :notifier.tabBar4,),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      height: height/20,
                      width: width/7,
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: index6==4?const Color(0xff6B39F4)  :notifier.tabBar4,),
             ...
             AppConstants.Height(20),
              ...
              AppConstants.Height(20),
              const Text("View more",style: TextStyle(color: Color(0xff6B39F4),fontSize: 16,fontFamily: "Manrope-Bold"),),
              AppConstants.Height(20),
              Row(
                children: [
