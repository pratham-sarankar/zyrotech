                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: _getStatusColor(personalStatus).withOpacity(0.2),
                                ...
                                Flexible(
                                  child: Text(
                                    _getStatusText(personalStatus) == "Completed" 
                                ...
                                Row(
                                  ...
                                  children: [
                                    Container(
                                      padding: const EdgeInsets.all(6),
                                      decoration: BoxDecoration(
                                        color: _getStatusColor(kycStatus).withOpacity(0.2),
                                        borderRadius: BorderRadius.circular(10),
                                      ),
                                      child: Icon(
                    ...
                    child: Column(
                      children: [
                        _buildRequirementItem(
                          ...
                          description: "Full name, date of birth, gender, PAN/Aadhaar",
                          isCompleted: false,
                        ),
                        ...
                        _buildRequirementItem(
                          ...
                          description: "Income, investment preferences, risk tolerance",
                          isCompleted: false,
                        ),
                        const Divider(height: 30),
                        _buildRequirementItem(
                          ...
                          description: "Investment amount, trading preferences, risk limits",
                          isCompleted: false,
                        ),
                      ],
                    ),
